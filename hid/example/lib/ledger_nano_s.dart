...
import '../../lib/hidapi_service.dart';
import '../../lib/hidapi_service_mac.dart';
...
void main(List<String> args) {
  LedgerNanoSImpl ledgerNanoSImpl = LedgerNanoSImpl();
  ...
  ledgerNanoSImpl.connectLedger(apdu);
}
